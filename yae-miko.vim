...
" taken from shado bright colors
let s:gb.bright_red     = ['#b52a5b', 168]     " 251-73-52
let s:gb.bright_green   = ['#ff4971', 204]     " 184-187-38
let s:gb.bright_yellow  = ['#8897f4', 147]     " 250-189-47
let s:gb.bright_blue    = ['#bd93f9', 183]     " 131-165-152
let s:gb.bright_purple  = ['#e9729d', 211]     " 211-134-155
let s:gb.bright_aqua    = ['#f18fb0', 217]     " 142-192-124
let s:gb.bright_orange  = ['#f1c4e0', 224]     " 254-128-25

" NOTE: neutral is only used in nvim 
let s:gb.neutral_red    = ['#b52a5b', 168]     " 204-36-29
let s:gb.neutral_green  = ['#ff4971', 204]     " 152-151-26
let s:gb.neutral_yellow = ['#8897f4', 147]     " 215-153-33
let s:gb.neutral_blue   = ['#bd93f9', 183]      " 69-133-136
let s:gb.neutral_purple = ['#e9729d', 211]     " 177-98-134
let s:gb.neutral_aqua   = ['#f18fb0', 217]      " 104-157-106
let s:gb.neutral_orange = ['#f1c4e0', 224]     " 214-93-14

" TODO: make faded versions of above
let s:gb.faded_red    = ['#b52a5b', 124]     " 204-36-29
let s:gb.faded_green  = ['#ff4971', 106]     " 152-151-26
let s:gb.faded_yellow = ['#8897f4', 172]     " 215-153-33
let s:gb.faded_blue   = ['#bd93f9', 66]      " 69-133-136
let s:gb.faded_purple = ['#e9729d', 132]     " 177-98-134
let s:gb.faded_aqua   = ['#f18fb0', 72]      " 104-157-106
let s:gb.faded_orange = ['#f1c4e0', 166]     " 214-93-14
